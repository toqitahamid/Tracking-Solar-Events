...
event_type = 'AR'
module = 'HMI'
file_starttime = '2015-01-01'
file_endtime = '2016-12-31'



startTime = '2015-01-01 00:02:00'
endTime = '2016-12-31 23:58:00'
...
results = client.search(hek.attrs.Time(startTime, endTime), hek.attrs.EventType('AR'), hek.attrs.FRM.Name == 'HMI SHARP')
...
def get_radius(event_starttime):
    ...
    filepath = hv.download_jp2(event_starttime, observatory='SDO', instrument='AIA', detector='HMI', measurement='171', sourceId = '10', directory='helioviewer/')
...
def draw_limb(filepath, radius):
    save_directory = 'helioviewer/jpg/'
    if not os.path.isdir(save_directory):
        os.makedirs(save_directory)
        
    bbox_directory = 'helioviewer/bbox/'
